...
public final class Input extends TorqueInput<TorqueController> implements Subsystems {
    ...
    private Input() {
        ...
        alignGridLeft = new TorqueBoolSupplier(driver::isDPADLeftDown);
        alignGridCenter = new TorqueBoolSupplier(driver::isDPADDownDown);
        alignGridRight = new TorqueBoolSupplier(driver::isDPADRightDown);
