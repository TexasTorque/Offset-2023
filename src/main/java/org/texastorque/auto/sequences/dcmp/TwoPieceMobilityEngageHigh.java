...
public final class TwoPieceMobilityEngageHigh extends TorqueSequence implements Subsystems {
    public TwoPieceMobilityEngageHigh() {
        ...
        addBlock(new FollowEventPath("flat-side-go-level-3"));
