...
public final class Middle1E extends TorqueSequence implements Subsystems {
    public Middle1E() {
        ...
        addBlock(new FollowEventPath("engage-out", 2.5, 3.5));
        addBlock(new TorqueWaitForSeconds(2));
        addBlock(new FollowEventPath("engage-in", 2.5, 3.5));
