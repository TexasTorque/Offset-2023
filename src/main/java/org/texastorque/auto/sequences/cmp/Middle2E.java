...
public final class Middle2E extends TorqueSequence implements Subsystems {
    public Middle2E() {
        ...
        addBlock(new FollowEventPath("engage-out-2", 2.5, 3.5));
        addBlock(new TorqueWaitForSeconds(.25));
        addBlock(new FollowEventPath("engage-pickup", 2.5, 3.5));
