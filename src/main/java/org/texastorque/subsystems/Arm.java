...
public final class Arm extends TorqueSubsystem implements Subsystems {
    ...
    public static enum State {
        HANDOFF(new ArmPose(0, Rotation2d.fromRadians(0))),
        // Position to grab from indexer (contacts indexer)
        DOWN(new ArmPose(0, Rotation2d.fromRadians(0))),
        // Position to grab from ground (contacts ground)
        SHELF(new ArmPose(.5, Rotation2d.fromRadians(Math.PI))),                  // Position to grab from shelf (contacts shelf)
        MID(
        ...
        TOP(
                new ArmPose(.5,  Rotation2d.fromRadians(0)), 
                new ArmPose(0,  Rotation2d.fromRadians(0))
